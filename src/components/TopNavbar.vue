  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Услуги и цены</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Объекты</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Отзывы о нас</a></li>
